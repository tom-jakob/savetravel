...
public class ApiService {
	...
	public TravelWarningObject getTWfromAPIService(String coco) {
...
//	public CoronaObject getAllCoronaData() {
//		
//		RestTemplate restTemplate = new RestTemplate();
//		
//		CoronaObject allCoronaObject = new CoronaObject();
//		
//		ResponseEntity<CoronaObject> responseEntity = restTemplate.getForEntity(url, responseType)
//		
